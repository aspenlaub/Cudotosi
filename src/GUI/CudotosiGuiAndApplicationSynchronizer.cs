...
public class CudotosiGuiAndApplicationSynchronizer : GuiAndApplicationSynchronizerBase<CudotosiApplicationModel, CudotosiWindow> {
    public CudotosiGuiAndApplicationSynchronizer(CudotosiApplicationModel model, CudotosiWindow window, ISimpleLogger simpleLogger) : base(model, window, simpleLogger) {
    }
